...
__DEFINE__(1737092567502, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1737092567503,"./event-store":1737092567504}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1737092567503, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1737092567504, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1737092567503,"./utils":1737092567505}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1737092567505, function(require, module, exports) {
...
return __REQUIRE__(1737092567502);
})()
